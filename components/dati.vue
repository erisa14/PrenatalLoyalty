<template>
  <div class="flex flex-row">
    <div class=" flex flex-col gap-4">
      <div class="conteiner  bg-[#F7F7F7]  lg:p-8 p-6 rounded-3xl lg:w-full md:w-[80%] w-[92%] mx-auto">
        <div class="md:flex flex-row md:gap-24 gap-32">
          <div class="flex flex-col text-lg">
            <h2 class="text-[#E72B6F] text-xl font-bold ">I tuoi dati</h2>
            <ul class="font-semibold space-y-4 my-6 text-sm">
              <li> Nome:
                <span class="font-normal mx-2">Michela</span>
              </li>
          ...
          <div class=" pr-3 text-base">
            <h2 class="text-[#E72B6F] md:text-xl text-lg font-bold">I tuoi consensi</h2>
            <div class="border-b-2  divide-[#DEDEDE] flex flex-row items-center justify-between  md:py-6 py-2">
              <h3 class="md:w-full w-2/3 tracking-tight leading-5 md:text-lg">Puoi ricevere le nostre comunicazioni</h3>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" class="md:w-8 md:h-8 w-6 h-6"
                stroke="green">
                <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" />
              </svg>
            </div>
            <div class="border-b-2 divide-[#DEDEDE] flex flex-row items-center md:py-6 justify-between py-2">
              <h3 class="md:w-full w-2/3 tracking-tighter leading-5 md:text-lg">Puoi ricevere comunicazioni personalizzate</h3>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" class="md:w-8 md:h-8 w-6 h-6"
                stroke="green">
                <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" />
              </svg>
            ...
            <div class="border-b-2 divide-[#DEDEDE] flex flex-row items-center md:py-6 justify-between py-2">
              <h3 class="md:w-full w-2/3 tracking-tight leading-5 md:text-lg">Puoi rispondere a survey e sondaggi</h3>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" class="md:w-8 md:h-8 w-6 h-6"
                stroke="red">
            ...
            <div class="border-b-2  divide-[#DEDEDE] flex flex-row items-center md:py-6 justify-between py-2">
              <h3 class="md:w-full  w-2/3 md:text-lg tracking-tight leading-5">Puoi ricevere comunicazioni da altre società del
                Gruppo e/o da soggetti Terzi</h3>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5"
                class="md:w-8 md:h-8 w-6 h-6" stroke="red">
                <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
              </svg>
            </div>
          </div>
        </div>
        <div class="flex flex-col px-3 w-full md:mt-0 mt-5">
          <h1 class="text-[#E72B6F] text-xl font-bold mb-4">La tua famiglia</h1>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-2">
            <div class="flex items-center bg-white border border-gray-200 rounded-md shadow md:h-24">
              <img
                class="object-cover w-16 h-28 md:w-16 md:h-full rounded-l-lg "
                src="assets/boyy.png" alt="">
            ...
            <div class="flex items-center bg-white border rounded-lg shadow md:h-24">
              <img
                class="object-cover w-16 h-28 md:w-16 md:h-full  rounded-l-lg"
                src="assets/girl.png" alt="">
              <div class="flex flex-col justify-between p-4 leading-normal">
                <span class="mb-1 text-base font-semibold tracking-tight text-[#E72B6F] dark:text-white">Name</span>
                <p class="font-semibold text-sm  tracking-tighter dark:text-gray-400">Data di nascita: <span
                    class="font-normal">03/05/2020</span></p>
                <h6 class="font-semibold text-sm  tracking-tighter">Genere:</h6>
              </div>
            </div>
            <div class="flex items-center bg-white border rounded-lg shadow md:h-24">
          ...
          <a href="#" type="button"
            class="bg-[#E72B6F] self-start md:self-center text-white py-2 px-6  rounded-full text-lg text-center mt-5 mx-auto">MODIFICA</a>
        </div>
      </div>
      <div class="flex flex-col px-8 lg:py-7 md:py-3 py-3 rounded-3xl border border-b-7 border-gray-300 text-xl lg:w-full md:w-[80%] mx-auto">
        ...
        <div class="grid grid-cols-4 md:grid-cols-6 lg:flex flex-row gap-4 mt-8">
          <span class="rounded-full  bg-[#F9ECED] flex items-center justify-center ">
            <div class="rounded-full lg:w-16 lg:h-16 md:w-14 md:h-14 w-12 h-16 bg-[#F9ECED] flex items-center justify-center ">
              ...
              <svg viewBox="0 0 24 24" fill="none" height="32px" width="32px" xmlns="http://www.w3.org/2000/svg"
                ...
                <g id="SVGRepo_iconCarrier">
                  <path
                    ...
                    stroke="#E72B6F" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" />
                </g>
              </svg>
            </div>
          </span>
              ...
              <svg viewBox="0 0 24 24" fill="none" width="32px" height="32px" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="SVGRepo_iconCarrier">
                  <path
                    ...
                    stroke="#E72B6F" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path>
                </g>
              </svg>
            </div>
          </span>
          ...
          <span class="rounded-full  bg-[#F9ECED] flex items-center justify-center">
            <div class="rounded-full lg:w-16 lg:h-16 md:w-14 md:h-14  w-12 h-16 bg-[#F9ECED] flex items-center justify-center">
              <svg class="h-8 w-8 text-[#E72B6F] " viewBox="0 0 24 24" fill="none" stroke="currentColor"
