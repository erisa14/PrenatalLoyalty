<template>
        ...
        <div class="relative z-20 mx-auto flex max-w-screen-2xl justify-between p-8 ">
            ...
            <div class="border-3xl shadow-lg bg-white rounded-2xl p-2  w-2/5 -translate-y-8">
                <div class="flex flex-row -space-x-9 text-[#227098] justify-center">
                    ...
                    <h3 class="inline-block logo text-[#227098] px-3 py-3 mt-7" title="Prénatal">
                        <svg width="410" height="75" viewBox="0 0 410 79" data-logo-icon="data-logo-icon"
                            class="block h-4 w-auto sm:h-3 -rotate-90" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <table class="table table-auto bg-[#f7f7f7] mt-5 min-w-full">
                    <thead class="text-left text-lg">
                        <tr class="">
                            ...
                            <th class="font-normal p-3"> Q.TÁ</th>
                            <th class="font-normal p-3">PREZZO</th>
                            <th class="text-[#227098] p-3">PREZZO VIP</th>
                        </tr>
                    </thead>
                    <tbody class="text-center">
                        <tr class="border-b border-gray-300">
                            <td class="font-bold text-left p-3">T-shirt manica lunga</td>
                            <td class="font-bold">1</td>
                            <td class="line-through">€15.99</td>
                            <td class="text-[#227098] font-bold">€11.19</td>
                        </tr>
                        <tr class="border-b border-gray-300">
                            <td class="font-bold text-left p-3">Light Jacket</td>
                            <td class="font-bold">1</td>
                            <td class="line-through ">€22.99</td>
                            <td class="text-[#227098] font-bold">€16.09</td>
                        </tr>
                        <tr class="border-b border-gray-300">
                            <td class="font-bold text-left p-3">Pantalone denim</td>
                            <td class="font-bold">1</td>
                            <td class="line-through ">€19.99</td>
                            <td class="text-[#227098] font-bold">€13.99</td>
                        </tr>
                        <tr class="border-b border-gray-300 border-solid">
                            <td class="font-bold text-left p-3">Calze pack x5</td>
                            <td class="font-bold">1</td>
                            <td class="line-through ">€9.99</td>
                            <td class="text-[#227098] font-bold">€6.99</td>
                        </tr>
                        <tr>
                            <td class="font-bold text-left p-3">T-shirt manica lunga</td>
                            <td class="font-bold">1</td>
        ...
        <div class="bg-[#005c8c] text-white p-10 max-w-screen-2xl mx-auto rounded-3xl -translate-y-44">
            ...
            <h3 class="text-center font-light">L'offerta Vip Card sui Pannolini è soggetta a cambiamenti in base alle condizioni di listino in corso.</h3>
...
<img class="rounded-3xl w-full" src="/assets/image.png" alt="image description">
<figcaption class="absolute flex flex-col space-y-10 top-20 align-middle text-white right-20">
  <h1 class="text-5xl leading-12 font-semibold ">Regala una VIP Card</h1>
  <p class="font-thin  text-xl leading-tight ">Da oggi puoi regalare la Vip Card a chi ami, in negozio o online</p>
  <a href="#" class="px-3 py-2 w-1/4 rounded-3xl text-center text-white text-xl bg-[#e82770]" type="button">ACQUISTALA SUBITO</a>
</figcaption>
