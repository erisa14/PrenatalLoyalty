<template>
    ...
    <div :class="{ 'shadow-gray': showAlert }" class="max-w-screen-2xl mx-auto flex flex-col mt-16">
        ...
        </span><a href="#" class="text-[#E72B6F] ">Torna alla pagina principale</a>
        </div>
        <div class="flex flex-col h-1/4">
            <img src="assets\yoga.jpg" alt="yogare image" class="w-auto h-full mt-4 rounded-lg">
            <img src="https://storage.googleapis.com/prg-loyalty.appspot.com/media/102/img-logo---595x422px.jpg" alt="yogare logo"class="-translate-y-32 w-5/12 h-60 self-center rounded-2xl" >
        </div>
        ...
        <g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 1; fill: none; fill-rule: nonzero; opacity: 1;" transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)" >
            ...
            <div class="flex items-center p-9">
                <div class="rounded-full w-80 h-32 bg-[#F7F7F7]">
                  <img src="/assets/vip-card.png" alt="Photo" class="w-28 h-auto rounded-xl -rotate-12 mt-7 mx-4 p-2">
                </div>
