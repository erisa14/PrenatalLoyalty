      ...
      <div class="grid grid-col gap-4 w-1/4">
        ...
        <div class="grid grid-col gap-6 px-9 py-10 rounded-3xl border border-gray-300">
          ...
          <div class="bg-[#e82770] text-white flex flex-row gap-2 rounded-3xl mt-8 py-3 px-6 w-35% mx-auto">
            <svg class="w-10 h-10" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="32" height="32"
              fill="none" viewBox="0 0 21 21">
              <path stroke="white" stroke-linecap="round" stroke-width="2"
                d="M7.926 10.898 15 7.727m-7.074 5.39L15 16.29M8 12a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Zm12 5.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Zm0-11a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z" />
            </svg> <button @click="shareLink" class="  text-xl mx-auto">CONDIVIDI</button>
          </div>
